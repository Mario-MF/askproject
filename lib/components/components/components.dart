...
Widget drfaultButton({@required String text,@required function})=>Container(
...
Widget defaultForm({@required String hintText,@required icon,controller,validator,bool obs=false})=> TextFormField(obscureText: obs,controller: controller,validator: validator,
  decoration: InputDecoration(
    prefixIcon: Icon(icon),border: OutlineInputBorder(),hintText: hintText,
  ),
);

Widget drfaultButtonn({@required String text,@required function})=>Container(
    width: double.infinity,
    height: 40,
    child: ElevatedButton(
      onPressed: function,
